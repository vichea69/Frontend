...
const Category = () => {
    ...
    return (
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
            ...
            {categories.length === 0 ? (
                <p className="text-primary dark:text-white justify-center items-center text-center text-2xl mt-5">
                    No categories available.
                </p>
            ) : (
                <div className="mt-16 shadow-sm border rounded-lg overflow-x-auto">
                    <table className="w-[100%] table-auto text-sm text-left">
                        <thead className="bg-gray-50 text-gray-600 font-medium border-b dark:bg-cyan-300 dark:text-red-500">
                        <tr>
                            ...
                            <tr key={category._id}>
                                ...
                                <td className="space-x-5">
                                    <DialogUpdateCategory
                                        category={category}
                                        onUpdate={async (id, updatedData) => await updateCategory(id, updatedData)}
                                    />
                                    <AlertDialogDemo
