  ...
  return (
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 ">
        ...
        <div className="mt-12 shadow-sm border rounded-lg overflow-x-auto">
          <table className="w-full table-auto text-sm text-left sm:text-base">
        ...
        <div className="block sm:hidden text-center mt-12">
          <p className="text-gray-700 dark:text-white">
            Table is hidden on smaller screens. Please use a larger device to view
            the product list.
          </p>
        </div>
      </div>
